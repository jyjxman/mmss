    ...
    $(function() {
        ...
        $('#organizationEditForm').form({
            ...
            success : function(result) {
                ...
                if (result.success) {
                    $.modalDialog.openner_treeGrid.treegrid('reload');//之所以能在这里调用到parent.$.modalDialog.openner_treeGrid这个对象，是因为organization.jsp页面预定义好了
...
<div style="padding: 3px;">
    <form id="organizationEditForm" method="post">
        <table class="grid">
            ...
            <tr>
                <td>排序</td>
                <td><input name="sortstring"  class="easyui-numberspinner" value="${organization.sortstring}" style="widtd: 140px; height: 29px;" required="required" data-options="editable:false"></td>
                <td>菜单图标</td>
