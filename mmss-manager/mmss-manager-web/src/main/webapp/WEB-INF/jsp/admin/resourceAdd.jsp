...
<div style="padding: 3px;">
    <form id="resourceAddForm" method="post">
        ...
        <tr>
        <td>编号</td>
        <td><input name="id" type="text" placeholder="编号" class="easyui-validatebox span2" data-options="required:true" ></td>
        <td>菜单路径</td>
        <td><input name="parentids" type="text" placeholder="请输入菜单路径" class="easyui-validatebox span2" data-options="required:true" ></td>
            ...
            <tr>
                ...
                <td>排序</td>
                <td><input name="sortstring" value="0"  class="easyui-numberspinner" style="width: 140px; height: 29px;" required="required" data-options="editable:false"></td>
            </tr>
            <tr>
                <td>菜单图标</td>
                <td ><input  name="icon" /></td>
                <td>状态</td>
                <td ><select name="available" class="easyui-combobox" data-options="width:140,height:29,editable:false,panelHeight:'auto'">
