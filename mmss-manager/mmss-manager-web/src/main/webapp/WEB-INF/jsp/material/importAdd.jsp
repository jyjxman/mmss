    ...
    <div data-options="region:'center',border:false" title="" style="overflow: hidden;padding: 3px;">
        <form id="userAddForm" method="post">
            <table class="grid">
                <tr>
                    <td>登录名</td>
                    <td><input name="usercode" type="text" placeholder="请输入登录名称" class="easyui-validatebox" data-options="required:true" value=""></td>
                    <td>姓名</td>
                ...
                <tr>
                   ...
                   <td>地址</td>
                    <td><input type="text" name="adreess" class="easyui-textbox"/></td>
                </tr>
               ...
               <tr>
                ...
                <tr>
                    ...
                    <td>用户状态</td>
                    <td>
                        <select id="status" name="locked" class="easyui-combobox" data-options="width:140,height:29,editable:false,panelHeight:'auto'">
