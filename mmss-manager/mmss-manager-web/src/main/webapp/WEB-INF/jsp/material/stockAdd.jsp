    ...
    <div data-options="region:'center',border:false" title="" style="overflow: hidden;padding: 3px;">
        <form id="userAddForm" method="post">
            <table class="grid">
                ...
                <tr>
                    <td>库存数量</td>
                    <td><input name="stocknum" type="text" placeholder="请输入库存数量" class="easyui-textbox" ></td>
                   <td>入库价格</td>
                  ...
                  <tr>
                   ...
                   <td>出库价格</td>
                    <td><input type="text" name="expoprice" placeholder="请输入出库价格" class="easyui-textbox"/></td>
              <td>价格单位</td>
                 ...
                 <tr>
               <td>库存描述</td>
               <td> <textarea name="stockdesc" style="height:60px;"></textarea></td>
              </tr>
            </table>
        </form>
    </div>
