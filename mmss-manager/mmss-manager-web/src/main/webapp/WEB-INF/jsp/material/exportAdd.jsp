    ...
    <div data-options="region:'center',border:false" title="" style="overflow: hidden;padding: 3px;">
        <form id="userAddForm" method="post">
            <table class="grid">
                ...
                <tr>
                    <td>出库数量</td>
                    <td><input name="exponum" type="text" placeholder="请输入入库数量" class="easyui-textbox" ></td>
                   <td>数量单位</td>
                  ...
                  <tr>
                    <td>出库价格</td>
                    <td><input name="expoprice" type="text" placeholder="请输入入库价格" class="easyui-textbox" ></td>
                   <td>价格单位</td>
                    <td><input name="priceunit" type="text" placeholder="请输价格单位" class="easyui-textbox"></td>
                </tr>
                  <tr>
               <td>出库描述</td>
               <td> <textarea name="expodesc" style="height:60px;"></textarea></td>
              </tr>
            </table>
        </form>
    </div>
