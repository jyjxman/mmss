...
<title>用户管理</title>
        ...
        dataGrid = $('#dataGrid').datagrid({
            ...
            },
            {
                ...
                formatter : function(value, row, index) {
                    var str = '';
                        <shiro:hasPermission name="export:edit">
                            str += $.formatString('<a href="javascript:void(0)" class="user-easyui-linkbutton-edit" data-options="plain:true,iconCls:\'icon-edit\'" onclick="editFun(\'{0}\');" >编辑</a>', row.id);
                        </shiro:hasPermission>
                        <shiro:hasPermission name="export:del">
                            str += '&nbsp;&nbsp;|&nbsp;&nbsp;';
    ...
    function editFun(id) {
       ...
       $.modalDialog({
            ...
            width : 500,
            height : 300,
            href : '${path }/export/editPage?id=' + id,
            buttons : [ {
                text : '确定',
                handler : function() {
                    $.modalDialog.openner_dataGrid = dataGrid;//因为添加成功之后，需要刷新这个dataGrid，所以先预定义好
...
<body class="easyui-layout" data-options="fit:true,border:false">
    ...
    <div data-options="region:'center',border:true,title:'出库记录列表'" >
        <table id="dataGrid" data-options="fit:true,border:false"></table>
    </div>
   
    <div id="toolbar" style="display: none;">
        <shiro:hasPermission name="export:add">
