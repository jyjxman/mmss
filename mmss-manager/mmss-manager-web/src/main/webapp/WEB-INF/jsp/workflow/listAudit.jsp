...
<form id="oorderAuditForm" name="oorderAuditForm" action="${baseurl}/schedule/submitOrderAudit.do" method="post">
					...
					<TABLE class="toptable grid" border=1 cellSpacing=1 cellPadding=4
						...
						<TBODY>
							...
							<TR>
								...
								<TD class=category width="35%">
								<textarea rows="3" cols="30" name="listAuditCustom.auditinfo" ></textarea>
								</TD>
